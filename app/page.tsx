...
export default function Home() {
  return (
    <div
      ...
      dir="rtl"
      style={{ zoom: 0.9, fontFamily: "'B Nazanin', 'BNazanin', Tahoma, sans-serif" }}
    >
      {/* ==================== HERO ==================== */}
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="grid gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
            <div>
              ...
              <p className="mt-5 max-w-xl text-lg leading-8 text-slate-900">
            ...
            <div className="grid gap-7">
              {challenges.map((item, index) => (
                <div
                  key={item}
                  className="group flex items-start gap-5 rounded-2xl border-2 border-slate-200 bg-slate-50 p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-blue-200 hover:bg-white hover:shadow-xl hover:shadow-blue-950/5"
                >
                  ...
                  <p className="pt-2 text-lg leading-7 text-slate-900">{item}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="flex flex-col justify-center p-7 md:p-12">
              {[
                ...
                return (
                  <div
                    key={step.number}
                    className={`relative flex gap-5 ${index !== 2 ? "pb-10" : ""}`}
                  >
                    {index !== 2 && (
          ...
          <div className="grid gap-5 lg:grid-cols-12">
            ...
            <div className="group overflow-hidden rounded-[28px] border border-slate-200 bg-slate-50 lg:col-span-5">
              <div className="p-6 md:p-8">
                ...
                <p className="mt-3 text-lg leading-7 text-slate-900">
            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-2 gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className="flex items-center gap-2 rounded-xl border border-white/10 bg-white/5 p-3 text-base text-slate-100"
                  >
              ...
              <div className="mt-8 space-y-4">
                {benefits.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-lg leading-7 text-slate-900">{item}</p>
                  </div>
                ))}
              </div>
            </div>
      ...
      <footer className="border-t border-slate-200 bg-white py-8">
        <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-4 text-sm text-slate-500 md:flex-row">
          ...
          <p className="text-base text-slate-700">سامانه یکپارچه مدیریت هوشمند رخدادهای شهری</p>
        </div>
      </footer>
    </div>
  );
